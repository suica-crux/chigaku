...
const Content: React.FC = () => {
  return (
    <div>
      ...
      <Text>
        ファインダーは、望遠鏡の上側についている小さい覗き口の名前です。望遠鏡本体より倍率が低く、その分広い範囲を探せます。
        <br />
      ...
      <Text>
        まず、観測したい対象を決めます。近いものの方がより適しています。例えば、比叡山のロープウェイやケーブルカーの駅がおすすめです。
      </Text>
      <Space />

      <Text size="lg">望遠鏡本体で中心を合わせる</Text>
      <Text>
        望遠鏡本体で対象を中心に合わせます。そのあと、黒いねじを締めておくのがおすすめです。
      </Text>
      <Space />
      ...
      <Text>
        本体とファインダーで対象を覗き、ずれてなければ調整完了です。お疲れさまでした。
        <br />
        もしずれていればもう一度調整しましょう。
      </Text>
    </div>
