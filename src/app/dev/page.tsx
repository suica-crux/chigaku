    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-300">chigakuプロジェクトの<code className="bg-purple-800/50 px-2 py-1 rounded">app/page.tsx</code>を理解しよう</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-4 mt-4">
                ...
                <p className="text-gray-300">
                  ...
                  ホームページ(<code className="bg-slate-700 px-2 py-1 rounded">/</code>)として機能し、
                  カスタムコンポーネント(<code className="bg-slate-700 px-2 py-1 rounded">Heading</code>, 
                  <code className="bg-slate-700 px-2 py-1 rounded ml-1">Text</code>)を使ってコンテンツを表示しています。
                </p>
              </div>
            </div>
          )}
                ...
                {[
                  {
                    ...
                    content: (
                      <div className="space-y-2 text-gray-300">
                        <p><strong className="text-purple-300">layout.tsx:</strong> 複数ページで共通のUI(ヘッダー、フッター等)を定義</p>
                        <p><strong className="text-pink-300">page.tsx:</strong> そのルート固有のコンテンツを定義</p>
                    ...
                    content: (
                      <div className="space-y-2 text-gray-300">
                        ...
                        <div className="bg-slate-900/70 p-3 rounded space-y-1 text-sm">
                          <div><code className="text-green-400">app/page.tsx</code> → <code className="text-blue-400">/</code></div>
                          <div><code className="text-green-400">app/about/page.tsx</code> → <code className="text-blue-400">/about</code></div>
                          <div><code className="text-green-400">app/manual/[category]/page.tsx</code> → <code className="text-blue-400">/manual/dome</code></div>
                        </div>
                      </div>
                    )
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-3 text-gray-300">
                        <p><code className="bg-slate-700 px-2 py-1 rounded">[category]</code>は動的セグメント。どんな値でも受け取れます。</p>
                        ...
                        <pre className="bg-slate-950 p-3 rounded text-xs overflow-x-auto"><code>{`// app/manual/[category]/page.tsx
export default async function CategoryPage(
  ...
  return <div>{category}のページ</div>;
                  ...
                  },
                  {
                    ...
                    content: (
                      <div className="space-y-3 text-gray-300">
                        <p className="text-yellow-300 font-semibold">このプロジェクトの特徴的な構造!</p>
                        
                        <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 p-4 rounded-lg border border-purple-500/30">
                          <p className="text-lg font-semibold text-purple-300 mb-2">📚 3階層のURL構造</p>
                          <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <code className="bg-slate-700 px-2 py-1 rounded">/manual/dome/prepare</code>
...
└── data/manual/
    └── dome/                 # カテゴリ名
        ...
        │   └── content.tsx   # 記事の中身
        └── howto/
            └── content.tsx`}</code></pre>
                        </div>

                        <div className="bg-green-900/20 border border-green-500/30 rounded p-3">
                          <p className="text-green-300 font-semibold mb-2">🔄 データフロー</p>
                          <ol className="space-y-1 text-sm list-decimal list-inside">
                            <li>URLから<code className="bg-slate-700 px-1 rounded">category</code>と<code className="bg-slate-700 px-1 rounded">topic</code>を取得</li>
                            <li><code className="bg-slate-700 px-1 rounded">data/manual/{'{category}'}/{'{topic}'}/content.tsx</code>を動的import</li>
                            <li><code className="bg-slate-700 px-1 rounded">titleLoader</code>でタイトルを変換</li>
                            <li>コンテンツをレンダリング</li>
                          </ol>
                        </div>
                        ...
                        <div className="bg-orange-900/20 border border-orange-500/30 rounded p-3">
                          ...
                          <pre className="bg-slate-950 p-2 rounded text-xs mt-2"><code>{`// data/manual/dome/order.json
["prepare", "howto", "quit", "ladder"]`}</code></pre>
                          <p className="text-sm mt-2">記事の表示順序を制御。ファイル名のアルファベット順ではなく、任意の順序で表示できます。</p>
                        </div>
                      </div>
                    )
                  }
                  ...
                  <div key={key} className="bg-slate-900/30 rounded-lg border border-purple-500/20">
                    ...
                    >
                      ...
                      {expandedSections[key] ? <ChevronDown className="w-5 h-5" /> : <ChevronRight className="w-5 h-5" />}
                    </button>
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-gradient-to-br from-blue-900/20 to-blue-800/10 p-4 rounded-lg border border-blue-500/30">
                    ...
                    <pre className="bg-slate-950 p-3 rounded text-xs overflow-x-auto"><code className="text-gray-300">{`export const metadata: Metadata = {
  title: 'トップページ - 同志社高校地学部',
};`}</code></pre>
                  ...
                  <div className="bg-gradient-to-br from-purple-900/20 to-purple-800/10 p-4 rounded-lg border border-purple-500/30">
                    ...
                    <pre className="bg-slate-950 p-3 rounded text-xs overflow-x-auto"><code className="text-gray-300">{`export default function Home() {
  return (
    <div>
      <Heading title="..." />
      <Text>...</Text>
                ...
                <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm text-gray-300">
                    <div className="flex items-start gap-2">
                      ...
                      <span>タイトルを表示。propsで<code className="bg-slate-700 px-1 rounded">title</code>を受け取る</span>
                    </div>
                    <div className="flex items-start gap-2">
                    ...
                    <p className="mt-2 text-yellow-300">
                      💡 これらは<code className="bg-slate-700 px-2 py-1 rounded">src/components/</code>で定義されています
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-slate-900/50 p-4 rounded-lg border border-purple-500/20">
                  ...
                  <div className="space-y-2 text-gray-300">
                    <div className="flex items-center gap-3">
                      <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">1</span>
                      <span>Next.jsがpage.tsxを読み込む</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">2</span>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">4</span>
                      <span>layout.tsxのchildrenとして挿入</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-sm">5</span>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="bg-gradient-to-r from-blue-900/30 to-blue-800/20 p-4 rounded-lg border border-blue-500/30">
                  <h3 className="text-xl font-semibold text-blue-300 mb-2">✨ 新しいページを追加するには</h3>
                  <ol className="space-y-2 text-gray-300 list-decimal list-inside">
                    <li><code className="bg-slate-700 px-2 py-1 rounded">src/app/</code>内に新しいフォルダを作成</li>
                    <li>その中に<code className="bg-slate-700 px-2 py-1 rounded">page.tsx</code>を作成</li>
                    <li>metadataとコンポーネントをエクスポート</li>
                    <li>完成! 自動的にルーティングされます</li>
                  </ol>
                  <pre className="bg-slate-950 p-3 rounded mt-3 text-xs overflow-x-auto"><code className="text-gray-300">{`// src/app/news/page.tsx
...
export default function NewsPage() {
  return <div>ニュースページ</div>;
                ...
                <div className="bg-gradient-to-r from-purple-900/30 to-purple-800/20 p-4 rounded-lg border border-purple-500/30">
                  <h3 className="text-xl font-semibold text-purple-300 mb-2">🎨 動的なコンテンツを追加</h3>
                  <p className="text-gray-300 mb-2">クライアントコンポーネントが必要な場合:</p>
                  <pre className="bg-slate-950 p-3 rounded text-xs overflow-x-auto"><code className="text-gray-300">{`'use client'; // この行を追加
  ...
  return <button onClick={() => setCount(count + 1)}>
    クリック数: {count}
                ...
                <div className="bg-gradient-to-r from-green-900/30 to-green-800/20 p-4 rounded-lg border border-green-500/30">
                  ...
                  <pre className="bg-slate-950 p-3 rounded text-xs overflow-x-auto"><code className="text-gray-300">{`import Link from 'next/link';

<Link href="/about">
  地学部について
</Link>`}</code></pre>
                  <p className="text-gray-300 text-sm mt-2">
                    Next.jsの<code className="bg-slate-700 px-2 py-1 rounded">Link</code>コンポーネントを使うと、ページ遷移が高速化されます!
                  </p>
                </div>
